import type {InstructorEnrollment, ManageEnrollmentRequest} from "../../../../../types/enrollment.types.ts";
...
export default function EditInstructorEnrollmentSheet({enrollment}: {enrollment: InstructorEnrollment}) {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Edit enrollment for {enrollment.student.firstName} {enrollment.student.lastName}.
          </SheetDescription>
        </SheetHeader>
